...
Features compute_features(const float *x, int N) {
  ...
  */
  ...
  Features feat;
  feat.zcr = (float) compute_zcr(x,N);
	feat.am = (float) compute_am(x,N);
	feat.p = (float) compute_power(x,N);
  return feat;
}
